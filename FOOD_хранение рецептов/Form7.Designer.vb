...
Partial Class Form7
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 5
        Label1.Text = "Фрикадельки с гнездами"
        ' 
        ' Button1
        ' 
        Button1.BackgroundImage = My.Resources.Resources.фрикадельки
        ...
        PictureBox2.Location = New Point(10, 500)
        ...
        Label3.Location = New Point(48, 502)
        Label3.Name = "Label3"
        Label3.Size = New Size(100, 28)
        Label3.TabIndex = 10
        Label3.Text = "45 минут "
        ' 
        ' Label4
        ' 
        Label4.AutoSize = True
        Label4.Font = New Font("Segoe UI Semibold", 10F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label4.Location = New Point(10, 469)
        Label4.Name = "Label4"
        Label4.Size = New Size(199, 28)
        Label4.TabIndex = 9
        Label4.Text = "Рыба под сметаной"
        ' 
        ' Button2
        ' 
        Button2.BackgroundImage = My.Resources.Resources.рыба_под_сметаной
        Button2.BackgroundImageLayout = ImageLayout.Zoom
        Button2.Location = New Point(10, 284)
        ...
        PictureBox3.Location = New Point(12, 782)
        ...
        Label5.Location = New Point(52, 784)
        Label5.Name = "Label5"
        Label5.Size = New Size(151, 28)
        Label5.TabIndex = 14
        Label5.Text = "1 час 20 минут "
        ' 
        ' Label6
        ' 
        Label6.AutoSize = True
        Label6.Font = New Font("Segoe UI Semibold", 10F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label6.Location = New Point(12, 742)
        Label6.Name = "Label6"
        Label6.Size = New Size(333, 28)
        Label6.TabIndex = 13
        Label6.Text = "Запеченный минтай в горшочках"
        ' 
        ' Button3
        ' 
        Button3.BackgroundImage = My.Resources.Resources.запеченный_минтай
        Button3.BackgroundImageLayout = ImageLayout.Zoom
        Button3.Location = New Point(12, 553)
        ...
        PictureBox4.Location = New Point(12, 1062)
        ...
        Label7.Location = New Point(52, 1062)
        Label7.Name = "Label7"
        ...
        Label8.Location = New Point(12, 1018)
        Label8.Name = "Label8"
        Label8.Size = New Size(268, 28)
        Label8.TabIndex = 17
        Label8.Text = "Пюре с фаршем в духовке"
        ' 
        ' Button4
        ' 
        Button4.BackgroundImage = My.Resources.Resources.пюре_с_фаршем
        Button4.BackgroundImageLayout = ImageLayout.Zoom
        Button4.Location = New Point(12, 831)
        ...
        GroupBox1.Location = New Point(-1, 1123)
